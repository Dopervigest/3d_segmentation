...
def get_surface(mesh, surface_point_method='sample',
                             sign_method='normal', scan_count=100, scan_resolution=400,
                               sample_point_count=100000, return_gradients=False):
    #mesh = scale_to_unit_sphere(mesh)
...
def get_sdf(mesh, query_points, number_of_points = 500000, surface_point_method='scan',
                             sign_method='normal', normal_sample_count=11, min_size=0, return_gradients=False):
    
    return mesh.sample_sdf_near_surface(query_points, number_of_points, surface_point_method=='scan', sign_method, normal_sample_count, min_size, return_gradients)
