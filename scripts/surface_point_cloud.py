...
class SurfacePointCloud:
    ...
    def sample_sdf_near_surface(self, query_points,number_of_points=500000, use_scans=True, sign_method='normal', normal_sample_count=11, min_size=0, return_gradients=False):
        #query_points = []
